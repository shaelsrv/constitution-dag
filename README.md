...
python dag.py dumps/india-0.7.0 paths kotdwar

# one plate of food, five jurisdictions
python dag.py dumps/india-0.7.0 object food

# what can a citizen invoke — and what does NOT exist
python dag.py dumps/india-0.7.0 rights

# HOW does an office reach you: directly, or through command chains?
python dag.py dumps/india-0.7.0 effect kotdwar "prime minister"

# INSIDE an office: the ladder from the head down to the peon
python dag.py dumps/india-0.7.0 inside "district collector"

# export a mermaid diagram
python dag.py dumps/india-0.7.0 paths kotdwar --mermaid kotdwar.md
```
...
|---|---|---|
| `dumps/india-0.7.0` | **current** — full internal office structure: 278k sanctioned posts (DM to peon) across 6 office classes | [nationAtlas](https://emergencemachine.com) (private during beta) |
