...
python dag.py dumps/india-0.2.0 paths kotdwar

# one plate of food, five jurisdictions
python dag.py dumps/india-0.2.0 object food

# what can a citizen invoke — and what does NOT exist
python dag.py dumps/india-0.2.0 rights

# export a mermaid diagram
python dag.py dumps/india-0.2.0 paths kotdwar --mermaid kotdwar.md
```
...
|---|---|---|
| `dumps/india-0.2.0` | **current** — constitutional-completeness pass (all 24 domains allocated; 9 constitutional bodies added) | [nationAtlas](https://emergencemachine.com) (private during beta) |
